  ...
  return (
    <section className="flex flex-col gap-2 sm:flex-row overflow-hidden">
      <motion.article
        ...
        initial="hidden"
        animate="visible"
        className="scroll-smooth scrollbar scrollbar-h-2 scrollbar-w-2 scrollbar-thumb-blue-500/50 hover:scrollbar-thumb-blue-500/80 scrollbar-thumb-rounded-full pe-0.5 w-full max-w-[90vw] h-[90px] max-sm:place-self-center grid grid-flow-col auto-cols-[100px] overflow-x-auto overflow-y-hidden sm:overflow-y-auto sm:overflow-x-hidden gap-2 sm:auto-cols-auto sm:w-[80px] sm:h-[300px] sm:grid-flow-row sm:auto-rows-[80px]"
      >
        {imgs.map((src, i) => (
          <motion.div
            key={i}
            ...
            className="cursor-pointer hover:border-2 border-blue-500 h-full"
